...
public class Classe extends Instance {
    public Classe(Class c) throws ClassNotFoundException {
        super(c);
    }
     ...
     * @return
     */
    public Instance getParent() throws ClassNotFoundException {
        Classe parent = null;
     ...
     */
    public List<Interface> getInterfaces() throws ClassNotFoundException {
